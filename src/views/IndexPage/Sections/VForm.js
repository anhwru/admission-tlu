								...
								<GridContainer>
									...
									<b>THÔNG TIN ĐĂNG KÝ XÉT TUYỂN</b>
										...
										<GridItem xs={6} lg={6} md={6} sm={12} className="add_wish">
												<Button round color="info"><Add style={{color: "#FFFFFF"}}/>Thêm nguyện vọng</Button>
																		...
																		content:
																				<div id="info-form">
																						...
																						<GridContainer>
																								...
																								<GridItem sm={4} xs={4} lg={4} className="mg-10">
																										<TextField id="outlined-basic" value={stateInfoRecords.idMajors}
																								...
																								<>
																										...
																										<GridItem sm={4} xs={4} lg={4} className="mg-10">
																												<TextField id="outlined-basic" name="lop10_mon1"
																																	 onChange={handleChangeStateInfoRecords}
																																	 label="Môn thứ nhất"
																																	 variant="outlined" required={true}/>
																										</GridItem>
																										<GridItem sm={4} xs={4} lg={4} className="mg-10">
																												<TextField id="outlined-basic" name="lop10_mon2"
																																	 onChange={handleChangeStateInfoRecords}
																																	 label="Môn thứ 2" variant="outlined"
																																	 required={true}/>
																										</GridItem>
																										<GridItem sm={4} xs={4} lg={4} className="mg-10">
																												<TextField id="outlined-basic" name="lop10_mon3"
																																	 onChange={handleChangeStateInfoRecords}
																								...
																								<>
																										...
																										<GridItem sm={4} xs={4} lg={4} className="mg-10">
																												<TextField id="outlined-basic" name="lop11_mon1"
																																	 onChange={handleChangeStateInfoRecords}
																																	 label="Môn thứ nhất"
																																	 variant="outlined" required={true}/>
																										</GridItem>
																										<GridItem sm={4} xs={4} lg={4} className="mg-10">
																												<TextField id="outlined-basic" name="lop11_mon2"
																																	 onChange={handleChangeStateInfoRecords}
																																	 label="Môn thứ 2" variant="outlined"
																																	 required={true}/>
																										</GridItem>
																										<GridItem sm={4} xs={4} lg={4} className="mg-10">
																												<TextField id="outlined-basic" name="lop11_mon3"
																																	 onChange={handleChangeStateInfoRecords}
																																	 label="Môn thứ 3" variant="outlined"
																																	 required={true}/>
																										</GridItem>
																								...
																								<>
																										...
																										<GridItem sm={4} xs={4} lg={4} className="mg-10">
																												<TextField id="outlined-basic" name="lop12_mon1"
																																	 onChange={handleChangeStateInfoRecords}
																																	 label="Môn thứ nhất"
																																	 variant="outlined" required={true}/>
																										</GridItem>
																										<GridItem sm={4} xs={4} lg={4} className="mg-10">
																												<TextField id="outlined-basic" name="lop12_mon2"
																																	 onChange={handleChangeStateInfoRecords}
																																	 label="Môn thứ 2" variant="outlined"
																																	 required={true}/>
																										</GridItem>
																										<GridItem sm={4} xs={4} lg={4} className="mg-10">
																												<TextField id="outlined-basic" name="lop12_mon3"
																																	 onChange={handleChangeStateInfoRecords}
																																	 label="Môn thứ 3" variant="outlined"
																																	 required={true}/>
																										</GridItem>
