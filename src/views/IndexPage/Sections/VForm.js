												...
												title:
														<GridContainer>
																<GridItem xs={12} lg={12} md={12} className="mg-10">
																		<TextField label="Nguyện vọng" value={`Nguyện vọng ${key + 1}`} variant="outlined"
														...
														<div id="info-form">
																...
																<GridContainer>
																		<GridItem md={2} className="mw-12">
																				<Button color="danger" onClick={(data) => deleteConponent(key)}
																								round><Clear/> Xóa</Button>
																		</GridItem>
																</GridContainer>
														</div>
										}
								...
								<GridContainer>
									...
									<b>THÔNG TIN ĐĂNG KÝ XÉT TUYỂN</b>
										...
										<GridItem xs={6} lg={6} md={6} sm={12} className="add_wish">
												<Button round color="info" onClick={addNguyenVong}><Add style={{color: "#FFFFFF"}}/>Thêm nguyện
														vọng</Button>
										</GridItem>
